...
trait EloquentSaveTogether
{
    ...
    public function fillTogether(array $datas): self
    {
        ...
        if (! isset($this->togetherRequestKeys)) {
            $this->initializeHasTogether();
        }
        ...
        foreach ($this->together ?? [] as $key => $relation) {
            ...
            if (method_exists($this, $rel)) {
                ...
                try {
                    ...
                    // Skip if relation cannot be resolved (e.g., no database connection)
                    continue;
                }
    ...
    protected function fillMultiRecord($datas, $requestKey, $rel)
    {
        ...
        try {
            ...
            // Skip if relation cannot be resolved
            return;
        }
